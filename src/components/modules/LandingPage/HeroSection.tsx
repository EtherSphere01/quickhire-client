    ...
    return (
        <div className="container mx-auto relative overflow-visible px-4">
            <div className="flex justify-between">
                <div>
                    <div className="pt-2.5 w-full max-w-85.75 md:max-w-120 lg:max-w-133.25">
                        <h1 className="text-[36px] sm:text-[48px] md:text-[72px] text-[#25324B] font-semibold mt-4 lg:mt-20.5 leading-[110%] tracking-[0%]">
                            Discover more than
