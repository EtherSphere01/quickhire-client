            ...
            <div className="bg-white shadow-lg p-4  flex flex-col lg:flex-row lg:items-center gap-4 lg:gap-0">
                <div className="flex items-center gap-3 flex-1  lg:pr-5">
                    ...
                    <input
                        ...
                        className="w-full outline-none text-[16px] text-[#25324B] placeholder:text-[#7C8493] bg-transparent border-b py-4"
                    />
                </div>

                <div className="flex items-center gap-3 flex-1 lg:pl-5">
                    <LocationIcon />
                    <div className="flex items-center justify-between w-full lg:border-b py-4 ">
                        <input
                            type="text"
