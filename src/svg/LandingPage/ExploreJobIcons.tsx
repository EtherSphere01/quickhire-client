export const DesignIcon = ({ width = "48", height = "48" }) => {
    return (
        <svg
            width={width}
            height={height}
        ...
        >
            <g clipPath="url(#clip0_4844_1009)">
                <path
...
export const SalesIcon = ({ width = "48", height = "48" }) => {
    return (
        <svg
            width={width}
            height={height}
...
export const MarketingIcon = ({ width = "48", height = "48" }) => {
    return (
        <svg
            width={width}
            height={height}
...
export const FinanceIcon = ({ width = "48", height = "48" }) => {
    return (
        <svg
            width={width}
            height={height}
...
export const TechnologyIcon = ({ width = "48", height = "48" }) => {
    return (
        <svg
            width={width}
            height={height}
...
export const EngineeringIcon = ({ width = "48", height = "48" }) => {
    return (
        <svg
            width={width}
            height={height}
...
export const BusinessIcon = ({ width = "48", height = "48" }) => {
    return (
        <svg
            width={width}
            height={height}
...
export const HumanResourceIcon = ({ width = "48", height = "48" }) => {
    return (
        <svg
            width={width}
            height={height}
